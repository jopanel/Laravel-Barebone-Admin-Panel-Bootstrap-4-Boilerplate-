        ...
        <div class="collapse navbar-collapse" id="navbarExample">
            <ul class="sidebar-nav navbar-nav">
                <li class="nav-item active">
                    <a class="nav-link" href="<?=URL::to('/')?>/"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                </li>
                <li class="nav-item">
                    ...
                    <ul class="sidebar-second-level collapse" id="collapseComponents">
                        <li>
                            <a href="<?=URL::to('/')?>/settings/admins">Admins</a>
                        </li>
                        <li>
                            <a href="<?=URL::to('/')?>/settings/groups">Admin Groups</a>
                        </li> 
                    </ul>
                </li>
            </ul>
